...
function Login() {
    ...
    return (
        <div style={{ textAlign: 'center' }}>
            ...
            <label htmlFor="neUser">New User Sign up</label>


            <form onSubmit={handleSubmit}>
                {
                    newUser && <input onBlur={handleBlur} name="name" type="text" placeholder="Name" />
                }
                <br />
                <input onBlur={handleBlur} name="email" type="text" placeholder="Email" required />
                <br />
